...
WebUI.click(findTestObject('Page_CURA Healthcare Service/pilih_tanggal'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Test CICD')
